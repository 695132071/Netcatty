...
`,
  ...
  'vault.hosts.export.toast.proxyCredentialsSkipped': '有 {count} 个已保存的代理密码无法读取，导出时已留空',
  ...
  'vault.import.finalshell.promptTitle': '从 FinalShell 导入',
  'vault.import.finalshell.folder': 'conn 文件夹',
  'vault.import.finalshell.folderDesc': '导入全部 JSON 连接，并保留目录结构。',
  'vault.import.finalshell.file': '单个连接文件',
  'vault.import.finalshell.fileDesc': '导入一个 FinalShell JSON 连接。',
