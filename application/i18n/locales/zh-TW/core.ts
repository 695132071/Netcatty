...
export const zhTWCoreMessages: Messages = {
  ...
  'settings.appearance.tabBarPosition': '分頁列位置',
  'settings.appearance.tabBarPosition.top': '頂部',
...
`,
  ...
  'vault.hosts.export.toast.proxyCredentialsSkipped': '有 {count} 個已儲存的代理密碼無法讀取，匯出時已留空',
  ...
  'vault.import.finalshell.promptTitle': '從 FinalShell 匯入',
  'vault.import.finalshell.folder': 'conn 資料夾',
  'vault.import.finalshell.folderDesc': '匯入全部 JSON 連線，並保留目錄結構。',
  'vault.import.finalshell.file': '單一連線檔案',
  'vault.import.finalshell.fileDesc': '匯入一個 FinalShell JSON 連線。',
